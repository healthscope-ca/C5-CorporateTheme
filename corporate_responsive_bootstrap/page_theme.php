...
namespace Application\Theme\CorporateResponsiveBootstrap;
 
use Concrete\Core\Area\Layout\Preset\Provider\ThemeProviderInterface;

class PageTheme extends \Concrete\Core\Page\Theme\Theme implements ThemeProviderInterface {
//class PageTheme extends \Concrete\Theme\PageTheme {
    ...
    public function getThemeName() {
        return 'Corporate Responsive Bootstrap';
    }

    public function getThemeDescription() {
        return 'Responsive bootstrap updated theme';
    }

    public function getThemeAuthor() {
        return 'David Montana';
    }
