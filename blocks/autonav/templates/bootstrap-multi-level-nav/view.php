...
echo '<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-11">';
echo '<ul class="nav navbar-nav nav-left">'; //opens the top-level menu
...
foreach ($navItems as $ni) {
        ...
        if ($ni->hasSubmenu) {
                echo '<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">' . $ni->name . '<b class="caret"></b></a>';
        } else {
