...
<div class="ccm-tab-content" id="ccm-tab-content-form-options">
  ...
  <div class="panel-group list-group-root">
...
?> 
	<li class="list-group-item" data-toggle="collapse" data-children="<?php echo $childCount; ?>">
...
?> 
	<li class="list-group-item" data-toggle="collapse" data-children="<?php echo $childCount; ?>">
	    ...
	    <span class="pull-right">
	      ...
	      <button class="btn btn-xs btn-warning" onclick="deleteMe(this,10,1);return false">
	        <span class="glyphicon glyphicon-trash" ></span>
	      </button>
	    </span>		
	</li>
	
	<ul class="list-group collapses" id="<?php echo $itemID?>">
<?php
