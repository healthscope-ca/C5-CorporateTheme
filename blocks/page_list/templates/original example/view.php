    ...
    foreach ($pages as $page)
	{
        ...
        <?php if ($includeEntryText): ?>
            <div class="ccm-block-page-list-page-entry-text">
                ...
                <div class="ccm-block-page-list-title h2">
...
<?php 
	...
	{
		if ($date = $page->getAttribute('media_release_date')) 
		{
			// format date value in localised format based on language settings
			$date = $dh->formatCustom(t('F j, Y'), $date);
?>
